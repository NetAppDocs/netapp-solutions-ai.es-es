...
Instaclustr admite los conectores de Kafka Connect y sus detalles: link:https://github.com/instaclustr/kafka-connect-connectors["Más detalles"]. Instaclustr proporciona conectores adicionales link:https://www.instaclustr.com/support/documentation/kafka-connect/bundled-kafka-connect-plugins/["sus detalles"]
