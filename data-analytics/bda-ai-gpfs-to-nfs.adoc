...
summary: Esta sección proporciona los pasos detallados necesarios para configurar GPFS y mover datos a NFS mediante NetApp XCP. 
---
= Pasos detallados de GPFS a NFS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Esta sección proporciona los pasos detallados necesarios para configurar GPFS y mover datos a NFS mediante NetApp XCP.
...
…
....
. Instale el paquete de requisitos previos (incluido chef y los encabezados del kernel) en todos los nodos.
+
....
...
....
. Deshabilite SELinux en todos los nodos.
+
....
...
[root@mastr-51 5.0.3.1]#
....
. Configurar el nodo de instalación.
+
....
...
[root@mastr-51 installer]#
....
. Agregue el nodo de administración y el nodo GPFS al archivo de definición del clúster.
+
....
...
[root@mastr-51 installer]#
....
. Agregue el nodo administrador y el nodo GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Agregue el nodo de quórum y el nodo GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Agregue los servidores NSD y el nodo GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Agregue los nodos GUI, de administración y GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Verificar y enumerar todos los nodos.
+
....
...
[root@mastr-51 installer]#
....
. Especifique un nombre de clúster en el archivo de definición de clúster.
+
....
...
....
. Especifique el binario de shell remoto que utilizará GPFS; utilice `-r argument` .
+
....
...
[root@mastr-51 installer]#
....
. Especifique el binario de copia de archivo remoto que utilizará GPFS; utilice `-rc argument` .
+
....
...
[root@mastr-51 installer]#
....
. Añadir un nodo de administración.
+
....
...
[root@mastr-51 installer]#
....
. Verifique las configuraciones antes de la instalación.
+
....
...
....
. Verifique el estado del disco NSD.
+
....
...
[root@mastr-51 cluster-test]#
....
. Verifique y proporcione los permisos necesarios al GPFS.
+
....
...
. Instalar paquetes en el cliente NFS.
+
....
...
[root@hdp2 ~]#
....
. Validar la lista de archivos GPFS en la carpeta montada en NFS.
+
....
...
[root@hdp2 gpfstest]#
....
. Mueva los datos del NFS exportado mediante GPFS al NFS de NetApp mediante XCP.
+
....
