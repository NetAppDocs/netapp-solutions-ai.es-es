...
NetApp instaclustr también es compatible con Kafka con almacenamiento en niveles desde 3.8.1. Por favor, consulte más detalles aquí link:https://www.instaclustr.com/support/documentation/kafka-add-ons/using-kafka-tiered-storage/["Instaclust con almacenamiento por niveles de Kafka"]
